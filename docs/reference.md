...
The public API lives at the module root (`github.com/go-ruby-confd/confd`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `confd`, while the surface follows
...
```go
import "github.com/go-ruby-confd/confd"
```
...
- **[pkg.go.dev/github.com/go-ruby-confd/confd](https://pkg.go.dev/github.com/go-ruby-confd/confd)**

The module's [README](https://github.com/go-ruby-confd/confd#readme) carries worked
