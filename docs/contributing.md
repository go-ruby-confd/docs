...
Contributions are welcome. `go-ruby-confd/confd` is built to a small set of
...
The library is in [`github.com/go-ruby-confd/confd`](https://github.com/go-ruby-confd/confd).
This documentation site is in [`github.com/go-ruby-confd/docs`](https://github.com/go-ruby-confd/docs).
