# go-ruby-confd documentation

**Ruby-facing confd adapter over abtreece/confd — config templating from backend stores (CGO=0).**

`go-ruby-confd/confd` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `confd`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-confd/confd`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `confd`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`confd`](https://github.com/go-ruby-confd/confd) | the library — Ruby's `confd` in pure Go |
| [`docs`](https://github.com/go-ruby-confd/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-confd.github.io`](https://github.com/go-ruby-confd/go-ruby-confd.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-confd/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-confd/confd](https://github.com/go-ruby-confd/confd).
